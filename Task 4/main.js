onload = function () {
    // declaring variables        
            ...
            const calc = document.querySelector('#done');
            ...
            const doMath = function(){
                ...
                if(!value){
                    display.textContent = '';
                    /* added this if clause to make sure that when the = button is pressed and the display has no values, it will not output 'undefined'. (comment out the if block and see the result) */
                } else {
